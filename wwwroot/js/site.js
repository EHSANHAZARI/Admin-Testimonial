...
$(document).ready(function () {
    // Add a click event handler to the Testimonial link
    $('a[href="/testimonial"]').click(function (e) {
        e.preventDefault(); // Prevent the default behavior of the link

        var navItems = $('.navi ul li');

        // Add a click event listener to each li element
        navItems.click(function () {
            // Remove the active class from the currently active li element
...
$(document).ready(function () {
    // Add a click event handler for all navigation links
    $(".nav-link").click(function () {
        ...
        // Update the body class or another suitable element
        // to indicate the selected page based on the link
        $("body").removeClass().addClass("body-" + linkHref.substring(1));
    });
});